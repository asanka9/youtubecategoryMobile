...
/*
  addData() {
    print('Add Data');
    Map<String, dynamic> data = {'word': 'namoo buddhaya', 'age': 123};
    CollectionReference collectionReference =
    FirebaseFirestore.instance.collection('Book_data_02');
    collectionReference.doc().set(data);
  }*/
